...
[Ubuntu 23.04 (Lunar)](https://cloud-images.ubuntu.com/wsl/lunar/current/ubuntu-lunar-wsl-amd64-wsl.rootfs.tar.gz)
...
将 `ubuntu-kinetic-wsl-amd64-wsl.rootfs.tar.gz` 重命名为 `install.tar.gz`
